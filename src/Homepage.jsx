...
<div className="border-2 border-emerald-400 mx-auto bg-gradient-to-r from-white/70 to-white/40 backdrop-blur-xl px-6 sm:px-10 py-2 rounded-xl shadow-2xl w-11/12 sm:w-auto">
  ...
  <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
    ...
    {[
      ...
      <Link
        key={i}
        to={btn.to}
        className="text-white text-center px-4 py-3 rounded-xl text-base sm:text-lg font-semibold shadow-lg
      ...
      >
        ...
        {/* Info / Bio Section */}
        <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-2xl p-6 border-emerald-500 border-4 mx-auto my-4 w-11/12 md:w-3/4 lg:w-1/2 text-center space-y-6">
